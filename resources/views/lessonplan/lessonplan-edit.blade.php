                ...
                <form action="{{ route('lesson.plan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  value="{{ $lessonplan->video_url }}" placeholder="Enter Video Link">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Lesson No</label>
                            <input type="text" class="form-control"  value="{{ $lessonplan->lesson_no }}" placeholder="Enter Lesson No">
                        </div>
                        <div class="form-group">
